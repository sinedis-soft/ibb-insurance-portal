...
def migrated_database(monkeypatch: pytest.MonkeyPatch, sqlite_database_url: str, alembic_config: Config) -> str:
    ...
    monkeypatch.setenv("BITRIX24_BASE_URL", "https://bitrix.example.test/rest/1")
    monkeypatch.setenv("BITRIX24_WEBHOOK_TOKEN", "test-token")
    monkeypatch.setenv("BITRIX24_RETRY_BACKOFF_SECONDS", "0")
