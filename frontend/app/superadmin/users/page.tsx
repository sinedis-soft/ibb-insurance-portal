...
type AdminUser = {
  ...
  company_links: Array<{ bitrix_company_id: string; company_title: string | null; access_status: string }>;
...
export default function SuperadminUsersPage() {
  ...
  async function loadUsers() {
    ...
    try {
      const data = await requestJson<{ items: AdminUser[] }>(`/superadmin/users${suffix}`);
      setItems(data.items);
    } catch (error) {
