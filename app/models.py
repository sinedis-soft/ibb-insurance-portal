...
email_messages = sa.Table(
    ...
    sa.Column("recipient_ref", sa.String(128), nullable=False),
    ...
    sa.CheckConstraint(
        ...
        "'cancelled', 'delivered', 'bounced', 'rejected')",
    ...
    sa.Index("ix_email_messages_status_scheduled", "status", "scheduled_at"),
    sa.Index("ix_email_messages_template_code", "template_code"),
    sa.Index("ix_email_messages_event_type", "event_type"),
    sa.Index("ix_email_messages_target", "target_type", "target_id"),
    sa.Index("ix_email_messages_correlation_id", "correlation_id"),
)
